        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="page-header d-flex justify-content-between px-3">
                    <h4 class="mb-0">
                        <a class="text-dark" style="text-decoration:none" href="./commission">Commission</a>
                    </h4>
                </div>
                                        ...
                                        <div class="container-fluid px-4 pb-4">
                                            <div class="form-box">
                                                <form class="mt-3 row" method="post">
                                                    ...
                                                    <div class="form-group mt-2 col-sm-6">
                                                        <label for="commission">Set Commission</label>
                                                        <input class="form-control" id="commission" type="number"
                                                            name="commission" placeholder="commission" min="0">
                                                    </div>
